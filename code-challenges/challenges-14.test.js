...
let biggerThanLuke = (arr) => {
  // Solution code here...
  const newArr3 = arr.reduce((name, mass) => {
...
const detectTicTacToeWin = (board) => {
  ...
  if(newArr6[0]==newArr6[1]&& newArr6[0]==newArr6[2]&&newArr6[0]!='' ){
    return true;
  } else if(newArr6[2]==newArr6[5]&& newArr6[2]==newArr6[8]&&newArr6[2]!='' ){
    return true;}
  else if(newArr6[3]==newArr6[4]&& newArr6[3]==newArr6[5]&&newArr6[3]!='' ){
    return true;
  }else if(newArr6[6]==newArr6[7]&& newArr6[6]==newArr6[8]&&newArr6[6]!='' ){
    return true;
  }else if(newArr6[0]==newArr6[3]&& newArr6[0]==newArr6[6]&&newArr6[0]!='' ){
    return true;
  }else if(newArr6[1]==newArr6[4]&& newArr6[1]==newArr6[7]&&newArr6[1]!='' ){
    return true;
  }else if(newArr6[0]==newArr6[4]&& newArr6[0]==newArr6[8]&&newArr6[0]!='' ){
    return true;
  }else if(newArr6[2]==newArr6[4]&& newArr6[2]==newArr6[6]&&newArr6[0]!='' ){
    return true;
  }else{
    return false;
  }
